...
object Dependencies {
    ...
    val libSkelFlow =       "io.syspulse"                     %% "skel-flow"                      % skelVersion
    val libSkelScrap =      "io.syspulse"                     %% "skel-scrap"                     % skelVersion

    val libSkel = Seq(libSkelCore,libSkelCrypto, libSkelIngest, libSkelCron, libSkelFlow, libSkelScrap)
