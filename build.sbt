...
lazy val root = (project in file("."))
  .dependsOn(demo_ekm, demo_npp, demo_twit)
  //.aggregate(demo_ekm, demo_npp, demo_twit)
...
lazy val demo_ekm = (project in file("demo/skel-ekm"))
  ...
  .settings (
    ...
    libraryDependencies ++= libSkel ++ libAkka ++ libAlpakka ++ libPrometheus ++ Seq(
      libUpickleLib
    ),
  )
...
lazy val demo_npp = (project in file("demo/skel-npp"))
  ...
  .settings (
    ...
    libraryDependencies ++= libSkel ++ libDB ++ libTest ++ Seq(
      libCask,
      libOsLib,
      libUpickleLib,
      libScalaScraper,
